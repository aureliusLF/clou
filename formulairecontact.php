...
?>
<script src="js/FContact.js" defer></script>

<!-- Debut HTML formulaire -->
<h1 class="titreformu">
  Contactez-nous
</h1>
<form id="Contact" name="Contact" onsubmit="return formValid();">
  <fieldset>

    <legend><b> Informations requises </b></legend>
    ...
    <div>
      ...
      <label for="jj/mm/aaaa"> Date de naissance </label>
      <br>
      <input type="date" name="date" id="date" required min="01-02-1920" max="01-02-2005">
      <br>
      <span id="falsedate"></span>
      <br>
      ...
      <select name="metier">
        ...
        <option value="Politologue">Politologue </option>
      ...
      <label for="sujetmsg"> Sujet </label>
      <br>
      <input type="text" id="sujetmsg" required>
      <br>
      <span id="falsesujetmsg"></span>
      <br>
